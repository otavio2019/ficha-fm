...
describe("Homebrew genérico", () => {
  ...
  it("preserva mecânicas estruturadas e fornece valores seguros para conteúdo legado", () => {
    expect(normalizeHomebrewContent({ description: "Legado" }).mechanics).toEqual({ modifiers: [], requirements: [], evolutions: [], aptitude: { description: "", requirements: [], modifiers: [], effects: [], limitations: "", evolutions: [] } });

...
type TabId = "overview" | "attributes" | "skills" | "technique" | "spells" | "invocations" | "combat" | "equipment" | "house" | "diary";
...
export default function Home() {
  ...
  const [tab, setTab] = useState<TabId>(() => {
    ...
    return ["overview", "attributes", "skills", "technique", "spells", "invocations", "combat", "equipment", "house", "diary"].includes(requested ?? "") ? requested! : "overview";
  });

...
vi.mock("./db", () => ({
  ...
  getFMContentVersion: vi.fn(),
  getFMHomebrew: vi.fn(),
  getFMReview: vi.fn(),
  getFMTechnique: vi.fn(),
  getLatestFMContentVersion: vi.fn(),
  ...
  listFMContentVersions: vi.fn(),
  listFMContentVersionsByOwner: vi.fn(),
  listFMContentVotes: vi.fn(),
